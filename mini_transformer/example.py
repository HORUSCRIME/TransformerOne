"""
Example script demonstrating all features of the Mini Transformer
...
def test_kv_cache():
    """Test KV-cache for fast generation"""
    print("\n" + "="*60)
    ...
    # Generate with and without cache
...
def run_all_tests():
    ...
    try:
        ...
        print("="*60)
        print("\nYour Mini Transformer is ready to use!")
        print("\nNext steps:")
